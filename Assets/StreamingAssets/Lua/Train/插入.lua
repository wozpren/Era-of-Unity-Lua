...
if Active == "插入小穴" then
    if Select == "小穴" then
        ...
        if Trainer.IsJJ then
            base.V快乐 = trainData : CalcfStimulate("V刺激", 2)
        else
            base.V快乐 = trainData : CalcfStimulate("V刺激", 2) * (Factory : GetStuff("假阳具") + 90) / 100
        end
        base.V快乐 = EXABL(YJ, base.V快乐)

    elseif Select == "子宫口" then
        base.不洁 = 1500
        base.V快乐 = trainData : CalcfStimulate("V刺激", 2)
        base.V快乐 = EXABL(YJ, base.V快乐)
        if Train.HaveTalent("子宫性感") then
            base.V快乐 = base.V快乐 * 1.25
        else
            base.V快乐 = base.V快乐 * 0.25
            base.恐惧 =  base.恐惧 + 500
        end
...
elseif Active == "插入肛门" then
    ...
    base.逸脱 = 3000
    if Trainer.IsJJ then
        base.A快乐 = trainData : CalcfStimulate("A刺激", 2)
    else
        base.A快乐 = trainData : CalcfStimulate("A刺激", 2) * (Factory : GetStuff("假阳具") + 90) / 100
    end
    base.A快乐 = EXABL(YJ, base.A快乐)
    Improve.A扩张(Female, Trainer.Stature.JJSize, Trainer.Stature.JJHard)
elseif Active == "插入尿道" then
    base.不洁 = 1000
    base.屈服 = 10000
    base.逸脱 = 1000 + Trainer.Stature.JJSize * 5000
    base.疼痛 = 500
    base.恐惧 = 500
    base.尿快乐 = trainData : CalcfStimulate("尿道刺激", 2)
    base.尿快乐 = EXABL(YJ, base.尿快乐)
    Improve.尿道扩张(Female, Trainer.Stature.JJSize, Trainer.Stature.JJHard)
elseif Active == "指插入" then
    if Select == nil or Select == "G点" then
        base.不洁 = 150
        base.露出 = 300
        base.屈服 = 200 + VFeel * 200
        base.V快乐 = trainData : CalcfStimulate("Ｖ刺激", 1)
        if Select == "G点" then
            if VFeel >= 3 then
                base.V快乐 = base.V快乐 + 500 
            end
            base.不洁 = base.不洁 + 100 
            base.逸脱 = base.逸脱 + 500
        end
        base.V快乐 = EXABL(TTech, base.V快乐)
...
elseif Active == "拳交" then
    if Select == "小穴" then
        ...
        base.屈服 = base.屈服 + 2000
        base.逸脱 = base.逸脱 + 10000
        base.V快乐 = base.V快乐 + trainData : CalcfStimulate("V刺激", 3)
        base.V快乐 = EXABL(GetExpLV(Trainer : GetSexexp("手淫经验")), base.V快乐)
    elseif Select == "肛门" then
        base.不洁 = base.不洁 + 2000
        base.露出 = base.露出 + 1200
        base.屈服 = base.屈服 + 2000
        base.逸脱 = base.逸脱 + 20000
        base.V快乐 = base.V快乐 + trainData : CalcfStimulate("A刺激", 3)
        base.V快乐 = EXABL(GetExpLV(Trainer : GetSexexp("手淫经验")), base.A快乐)
    end
elseif Active == "探针" then
    base.屈服 = base.屈服 + 5000
    base.露出 = base.露出 + 2000
    base.逸脱 = base.逸脱 + 2000
    base.恐惧 = base.恐惧 + 500

    base.U快乐 = base.U快乐 + trainData : CalcfStimulate("尿道刺激", 0)
end
...
if Train.HaveTalent("柔软体质") and sized > 0 then
    sized = sized - 1
end
...
if sized < 0 then
    if sized == -1 then
        ...
        base.V快乐 = base.V快乐 * 1.2
        base.尿快乐 = base.尿快乐 * 1.2
    else
        base.A快乐 = base.A快乐 * math.max(1.2 + sized * 0.2, 0.5)
        base.V快乐 = base.V快乐 * math.max(1.2 + sized * 0.2, 0.5)
        base.尿快乐 = base.尿快乐 * math.max(1.2 + sized * 0.2, 0.5)
    end

    base.V快乐 = base.V快乐 * (hard * 0.1 + 0.8)
    base.V快乐 = base.V快乐 * (size * 0.1 + 0.9)
    base.A快乐 = base.A快乐 * (hard * 0.1 + 0.8)
    base.A快乐 = base.A快乐 * (size * 0.1 + 0.9)
    base.尿快乐 = base.尿快乐 * (hard * 0.1 + 0.8)
    base.尿快乐 = base.尿快乐 * (size * 0.1 + 0.9)

    if size >= 2 then 
        base.达成感 = base.达成感 + size * size * 500
    end
else
    trainData.DownHP = trainData.DownHP * (1 + size * 0.2)
    base.V快乐 = base.V快乐 / math.max(size * 2, 1)
    base.A快乐 = base.A快乐 / math.max(size * 2, 1)
    base.尿快乐 = base.尿快乐 / math.max(size * 2, 1)

end

base.疼痛 = base.疼痛 + PalamLV((sized + hard + 1)/2)  
base.恐惧 = base.恐惧 + PalamLV((sized + hard + 1)/2)  
base.逸脱 = base.逸脱 + PalamLV(sized)
...
if Select == "小穴" or Select == "G点" or Select == "子宫口" then
    ...
    elseif Female.Mark[4] > 0 then
        ...
        base.逸脱 = base.逸脱 / (1 - Female.Mark[4] * 0.15)
    end
    if trainData.equipItem : Contains("肌肉松弛剂") then
        base.V快乐 = base.V快乐 * 0.7
        base.疼痛 = base.V快乐 * 0.5
    end

    exp = math.min(GetExpLV(Female : GetSexexp("V经验")) - size - 1 - math.max(sized, 0), 5 - hard)

elseif Select == "子宫" then
    if Female.Mark[4] > 0 then
        base.充足 = base.充足 + Female.Mark[4] * 1000
    end
    local ZGLV = GetExpLV(Female.GetSexexp("子宫经验"))
    if ZGLV <= 1 then
        base.V快乐 = base.V快乐 * 0.2
        base.疼痛 = base.疼痛 + 1000
        base.恐惧 = base.恐惧 + 3000
        base.逸脱 = base.逸脱 + 30000
    elseif ZGLV <= 2 then
        base.V快乐 = base.V快乐 * 0.4
        base.疼痛 = base.疼痛 + 500
        base.恐惧 = base.恐惧 + 1000
        base.逸脱 = base.逸脱 + 6000
    else
        base.V快乐 = base.V快乐 * 0.7
        base.疼痛 = base.疼痛 + 500
        base.恐惧 = base.恐惧 + 1000
    ...
    if Train.HaveTalent("淫壶") or Female.Mark[4] >= 4 then
        base.疼痛 = base.疼痛 / 3 
        base.恐惧 = base.恐惧 / 3 
        base.逸脱 = base.逸脱 / 3
    ...
    exp = math.min(GetExpLV(Female : GetSexexp("子宫口经验")) - size - 1 - math.max(sized, 0), 5 - hard)
...
elseif Select == "肛门" or Select == "插入乙状结肠" then
    if Select == "乙状结肠" then
        ...
        if JCexp <= 0 then 
            ...
            base.逸脱 = base.逸脱 + 10000
        elseif JCexp <= 1 then
            base.V快乐 = base.V快乐 * 0.5
            base.屈服 = base.屈服 + 1000
            base.疼痛 = base.疼痛 + 500
            base.恐惧 = base.恐惧 + 3000
            base.逸脱 = base.逸脱 + 3000
        elseif JCexp <= 2 then
            base.V快乐 = base.V快乐 * 1.2
            base.屈服 = base.屈服 + 2000
            base.疼痛 = base.疼痛 + 100
        ...
        elseif JCexp <= 3 then
            ...
            base.屈服 = base.屈服 + 3000
        end
    end

    if Train.HaveTalent("尻穴狂") then
        base.疼痛 = base.疼痛 / 3 
        base.恐惧 = base.恐惧 / 3 
        base.逸脱 = base.逸脱 / 3 
    end
    if trainData.equipItem : Contains("肌肉松弛剂") then
        base.A快乐 = base.A快乐 * 0.7
        base.疼痛 = base.疼痛 * 0.5
    end
    if Active == "插入肛门" then
        palamRes = GetPalamLV(trainData.Source : get_Item("润滑")) - math.max(sized,0) - 1
    ...
    exp = math.min(GetExpLV(Female : GetSexexp("A经验")) - size - 1 - math.max(sized, 0), 5 - hard)
...
elseif Select == "尿道" or Active == "探针" then
    ...
    elseif Train.HaveTalent("尿道性感") then
        base.恐惧 = base.恐惧 * 0.2
        base.逸脱 = base.逸脱 * 0.2 
        base.疼痛 = base.疼痛 * 0.2
    end
    ...
    exp = math.min(GetExpLV(Female : GetSexexp("尿道经验")) - size - 1 - math.max(sized, 0), 5 - hard)
end
...
if sized <= 1 and (Female:GetAbility("好色") or tostring(Female.Feel) == "堕落" or Train.HaveTalent("柔软体质")) then
    base.疼痛 = base.疼痛 * 0.6
    base.恐惧 = base.恐惧 * 0.6
    base.屈服 = base.屈服 * 0.6
...
elseif palamRes ==2 then
    ...
    base.A快乐 = base.A快乐 * 0.8
elseif palamRes ==1 then
    base.疼痛 = base.疼痛 + 100
    base.V快乐 = base.V快乐 * 0.4
    base.A快乐 = base.A快乐 * 0.4
else
    base.疼痛 = base.疼痛 + 500
    base.V快乐 = base.V快乐 * 0.1
...
if Active == "插入小穴" then
    ...
    if t >= 200 then
        ...
        base.屈服 = base.屈服 * 3
    elseif t >= 150 then
        base.V快乐 = base.V快乐 * 2.5
        base.屈服 = base.屈服 * 2.5
    elseif t >= 100 then
        base.V快乐 = base.V快乐 * 1.75
        base.屈服 = base.屈服 * 1.75
    elseif t >= 50 then
        base.V快乐 = base.V快乐 * 1.25
        base.屈服 = base.屈服 * 1.25
    end
elseif Active == "插入肛门" then
    ...
    if t >= 200 then
        ...
        base.屈服 = base.屈服 * 3
    elseif t >= 150 then
        base.V快乐 = base.A快乐 * 2.5
        base.屈服 = base.屈服 * 2.5
    elseif t >= 100 then
        base.V快乐 = base.A快乐 * 1.75
        base.屈服 = base.屈服 * 1.75
    elseif t >= 50 then
        base.V快乐 = base.A快乐 * 1.25
        base.屈服 = base.屈服 * 1.25
    end
    if Select == "乙状结肠" then
...
elseif Active == "插入尿道" or Active == "探针" or Select == "尿道" then
    ...
    if t >= 200 then
        ...
        base.屈服 = base.屈服 * 3
    elseif t >= 150 then
        base.V快乐 = base.尿快乐 * 2.5
        base.屈服 = base.屈服 * 2.5
    elseif t >= 100 then
        base.V快乐 = base.尿快乐 * 1.75
        base.屈服 = base.屈服 * 1.75
    elseif t >= 50 then
        base.V快乐 = base.尿快乐 * 1.25
        base.屈服 = base.屈服 * 1.25
    end
    if Select == "膀胱口" then
        base.疼痛 = base.疼痛 + math.max(math.mix(DownPalamLv(base.疼痛, 1), base.疼痛 - 100), 0)
...
elseif Active == "指插入" or Active == "拳交" then
    ...
    if Select == "肛门" and Train.HaveTalent("A性向") then
        Train.LovePlay(base, base.A快乐)
    elseif Select == "小穴" and Train.HaveTalent("V性向") then
        Train.LovePlay(base, base.V快乐)
    end
